...
template.innerHTML = `
  ...
  <button type="button" aria-expanded="true" aria-label="收起現場互動畫面"><span></span></button>
  <div class="scrim" aria-hidden="true"></div>
  <aside aria-label="現場互動畫面">
    <iframe title="現場互動畫面" loading="eager" allow="clipboard-write"></iframe>
  </aside>
`;

class LiveDeckPanel extends HTMLElement {
  #button;
  #frame;
  #scrim;
  #target;
  ...
  #applyLayout = () => {
    ...
    this.#button.setAttribute("aria-label", collapsed ? "開啟現場互動畫面" : "收起現場互動畫面");
...
if (!customElements.get("live-deck-panel")) customElements.define("live-deck-panel", LiveDeckPanel);
